...
export default function Register() {
  ...
  const handleSubmit = async (e: Event) => {
    ...
    try {
      ...
      if (!result.error) {
        ...
        setError(result.error.message || "Ошибка регистрации. Попробуйте ещё раз.");
      }
    } catch (err: any) {
  ...
  return (
    <main class="min-h-screen flex items-center justify-center bg-neutral-50">
      <Title>Регистрация — Harkly</Title>
      <div class="w-full max-w-md p-8 bg-white rounded-2xl shadow-sm border border-neutral-200">
        <h1 class="text-2xl font-bold text-neutral-900 mb-2">Регистрация</h1>
        <p class="text-neutral-600 mb-6">Создайте новый аккаунт</p>
