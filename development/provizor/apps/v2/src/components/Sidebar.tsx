...
export type Page = 'dashboard' | 'pnl' | 'sku' | 'channels' | 'markup' | 'defectura' | 'turnover' | 'roadmap';
...
const NAV_ITEMS: { id: Page; label: string; icon: string }[] = [
  ...
  { id: 'defectura', label: 'Дефектура', icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z' },
  { id: 'turnover', label: 'Оборачиваемость', icon: 'M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4' },
