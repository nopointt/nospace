...
| **Mascot Meme canon v8** | brackets `[ ]` + face above (eye-dots only, NO mouth) + bronze + cyan-teal bioluminescent patina + 3-layer eyes + symmetric eyelid droop 15-20% + ≤30% patina + L2 default glow + locked proportions 7.7:1 + height as expression 92%-110%. Comprehensive spec at `nospace/marketing/branding/contexter/mascot/` (21 files, ~7000 lines, session 254). `mascot-meme.md` теперь короткий index pointing к folder. Subsections: README + philosophy + 7 canon-* (geometry / material-bronze / material-patina / bioluminescent-glow / face / composition / lighting) + states (7 canonical) + 2 motion-* (talk-animation 10-state RAG-grounded / idle-and-states) + 2 voice-* (and-copy / audio 12-dim sonic) + marketing-surfaces + cute-friendliness + anti-patterns + continuity-block (paste-ready) + decisions-log + references-rag-sources + open-questions. |
