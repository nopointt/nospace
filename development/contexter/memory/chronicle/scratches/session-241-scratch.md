# session-scratch.md
> Placeholder · Axis · 2026-04-13 · session 241
> Last processed checkpoint: #240
...
- Comment 1: fix "1.5GB RAM" → "few gigs of RAM" (Docling actually uses 3GB)
- Comment 5: fix cache_read claim → frame as observation not fact

**Notes:**
- Qdrant Bauhaus RAG was offline (localhost:6333 not reachable)
- Research reglament loaded per B8
- All 5 comments fact-checked via WebSearch, 2 minor corrections identified
