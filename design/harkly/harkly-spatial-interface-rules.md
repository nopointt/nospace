...
**Bauhaus RAG (source of expertise for design decisions):**
- `nospace/design/design_system/` — full design system (guidelines, patterns, tokens, 6 domains)
- `nospace/design/design_system/AGENTS.md` — task → file lookup for AI agents
- `nospace/docs/tLOS/design/bauhaus-code/` — 107 extraction files from 14 Bauhausbücher
...
- The canvas has **directional weight** (Kandinsky basic plane): top = light/free, bottom = heavy/anchored, left = departure, right = arrival
