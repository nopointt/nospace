...
| Наши затраты (COGS) | $2,129 |
| Валовая прибыль | **$9,847** |
| Валовая маржа | 82.2% |
...
| Наши затраты (COGS) | $10,642 |
| Валовая прибыль | **$-642** |
| Валовая маржа | -6.4% |
| Enterprise gift — opportunity cost | $998 |
| Enterprise gift — реальный cash cost | $154.78 |
...
| Наши затраты (COGS) | $8,862 |
| Валовая прибыль | **$288** |
| Валовая маржа | 3.2% |
| Enterprise gift — opportunity cost | $1,497 |
| Enterprise gift — реальный cash cost | $232.17 |
...
| Наши затраты (COGS) | $10,719 |
| Валовая прибыль | **$-3,555** |
| Валовая маржа | -49.6% |
| Enterprise gift — opportunity cost | $1,497 |
| Enterprise gift — реальный cash cost | $232.17 |
| Выручка партнёра от своих клиентов | $11,880 |
