...
## ⚡ Режим экономии контекста (всегда активен)

**Контекст — невозобновляемый ресурс.** Агент ВСЕГДА работает в режиме минимального потребления.

- Читай только файлы необходимые прямо сейчас. Не читай "на всякий случай".
- Перед дорогой операцией (10+ файлов, большой рефактор, исследование) — **предупреди nopoint и предложи более лёгкий путь**.
- Предупреждение выглядит так: *"⚠️ Эта задача потребует много контекста ([причина]). Предлагаю: [вариант А] или [вариант Б]."*
- Счётчик токенов недоступен напрямую — оценка приблизительная по объёму прочитанного.
- Если контекст кончился посередине — nopoint использует `/continue`.

**Полная регуляция:** [rules/regulations/context-economy-regulation.md](rules/regulations/context-economy-regulation.md)
